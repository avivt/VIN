...
from convMultiValIterNN_T import convMultiValIterNN_T
from hvin import hvin
from vin import vin
from vin_untied import vin_untied
from convMars import convMars
from convMarsSingle import convMarsSingle
from FCN import fcn
from CNN import cnn
...
def main():
    ...
    if args.model == "conv":
        # CNN + FC network
        my_nn = convNN(model=args.model, im_size=[args.imsize, args.imsize], dropout=args.dropout,
    ...
    elif args.model == "valIterMulti":
        my_nn = convMultiValIterNN_T(model=args.model, im_size=[args.imsize, args.imsize], dropout=args.dropout,
        ...
        my_nn = vin_untied(model=args.model, im_size=[args.imsize, args.imsize], dropout=args.dropout,
                           devtype=args.devtype, grad_check=args.grad_check, reg=args.reg, k=args.k,
                           batchsize=args.batchsize, statebatchsize=args.statebatchsize)
    elif args.model == "valIterMultiBatch":
        # Hierarchical VI network
        my_nn = hvin(model=args.model, im_size=[args.imsize, args.imsize], dropout=args.dropout,
                     devtype=args.devtype, grad_check=args.grad_check, reg=args.reg, k=args.k,
                     batchsize=args.batchsize, statebatchsize=args.statebatchsize)
    elif args.model == "valIterMars":
        # Hierarchical VI network for Mars domain
        my_nn = convMars(model=args.model, im_size=[args.imsize, args.imsize], dropout=args.dropout,
                         devtype=args.devtype, grad_check=args.grad_check, reg=args.reg, k=args.k,
                         batchsize=args.batchsize, statebatchsize=args.statebatchsize)
    elif args.model == "valIterMarsSingle":
        # VI network for Mars domain
        my_nn = convMarsSingle(model=args.model, im_size=[args.imsize, args.imsize], dropout=args.dropout,
                               devtype=args.devtype, grad_check=args.grad_check, reg=args.reg, k=args.k,
                               batchsize=args.batchsize, statebatchsize=args.statebatchsize)
    else:
        # FC network
